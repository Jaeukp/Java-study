...
//    private ArrayList accountList = new ArrayList(accounts);
//    private ArrayList numAccount = new ArrayList<>();
...
//    Map<String, Double> accounts = new HashMap<>();
    ...
    public AccountManagement(int maxSize) {
        accounts = new HashMap<>(maxSize);
//        lst = new ArrayList<>(maxSize); // 계좌 목록 배열을 생성
